...
const Onboarding3 = () => {
  return (
      <View style={[general.container, { backgroundColor: Colors.background , alignItems:'center', padding:Sizes.padding}]}>
          ...
          <Image source={ images.mascotScan} style={{height:'50%', width:'90%',resizeMode:'contain'}} />
          <Text style={{ ...FONTS.h1, color: Colors.text, fontWeight: 'bold', textAlign:'center', marginTop:Sizes.padding}}>Never Lose A Scan</Text>
    <Text style={{...FONTS.body3, color:Colors.bodyText, textAlign:"center", marginTop:Sizes.padding}}>Every scan is automatically tagged and securely saved locally. Use the History tab to search and filter your data by type (URL, Phone, Email) instantly.</Text>
